                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tbody>
                                            ...
                                            <tr style="display: flex;align-items: center; justify-content: center;">
                                                <td style="background-color: #09005D; width: 60%; height: 50px; margin-bottom: 40px;">
                                                    <span style="display: flex; align-items: center; justify-content: center; border-radius: 10px;">
                                                        <p style="color: #ffffff; font-family: Arial, Poppins, Helvetica, sans-serif; font-size: 40px; font-weight: 700; letter-spacing: 1px; line-height: 1.2; text-transform: none; text-align: center; padding: 0; margin: 0;">
                                                            {{ $mailData['body'] }}
                                                        </p>
                                                    </span>
                                                </td>
