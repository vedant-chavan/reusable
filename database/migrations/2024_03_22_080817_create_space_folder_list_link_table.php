...
return new class extends Migration
{
    ...
    {
        Schema::create('space_folder_list_link', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('space_xid');
            $table->unsignedBigInteger('color_xid');
            $table->unsignedBigInteger('priority_xid');
            $table->unsignedBigInteger('space_folder_link_xid');
            ...
            $table->foreign('space_folder_link_xid')->references('id')->on('space_folder_link')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('space_folder_list_link');
    }
};
